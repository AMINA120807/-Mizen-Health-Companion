      ...
      <div className="flex flex-col sm:flex-row gap-4 mb-8">
        <div className="flex-1">
          ...
          <select 
            ...
            className="w-full p-3 border border-gray-200 rounded-xl bg-white focus:outline-none focus:ring-2 focus:ring-primary shadow-sm"
          >
            {wilayas.map(w => (
      ...
      <div className="space-y-4">
        {filteredDietitians.length > 0 ? (
          filteredDietitians.map(dietitian => (
            <div key={dietitian.id} className="bg-white border border-gray-100 rounded-xl p-5 hover-lift shadow-sm">
              <div className="flex justify-between items-start mb-3">
                <div>
                  <h3 className="font-heading text-xl font-bold text-gray-900">{dietitian.name}</h3>
              ...
              <div className="pt-4 border-t border-gray-50 grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm text-gray-600">
