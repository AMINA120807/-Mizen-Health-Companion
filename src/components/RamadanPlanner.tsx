  ...
  return (
    <div className="bg-[#0b1912] text-emerald-50 p-4 md:p-6 rounded-[2rem] shadow-2xl relative overflow-hidden font-sans max-w-lg mx-auto border border-emerald-900/50">
      ...
      <div className="relative z-10 space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-700">
        ...
        <div className="[&_input]:bg-white/5 [&_input]:border-white/10 [&_input]:text-white [&_input]:placeholder-emerald-200/30 [&_.bg-white]:bg-black/40 [&_.bg-white]:border-white/10 [&_.text-gray-900]:text-emerald-50 [&_.text-gray-500]:text-emerald-200/50 [&_.border-gray-100]:border-white/10 [&_.bg-gray-50]:bg-white/5">
