    ...
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
      ...
      {mealItems.length > 0 && (
        <div className="w-full glass rounded-2xl p-6 shadow-xl space-y-6 relative overflow-hidden">
          ...
          <h2 className="font-heading text-2xl font-bold text-gray-900 dark:text-emerald-50 tracking-tight flex items-center gap-2">
            {t('meal.yourMeal')}
          </h2>
          
          <div className="space-y-4">
            {mealItems.map(item => (
              <div key={item.id} className="group flex flex-col gap-3 p-4 bg-white/50 border border-gray-100 dark:border-emerald-900/50 rounded-xl hover-lift">
                <div className="flex justify-between items-start">
                  <span className="font-heading font-semibold text-gray-900 dark:text-emerald-50 text-lg">{getFoodName(item.food)}</span>
                  <button 
                ...
                <div className="flex justify-between items-center bg-white dark:bg-emerald-950/40 p-2 rounded-lg shadow-sm border border-gray-50">
                  <span className="text-gray-500 dark:text-emerald-200/60 text-sm font-medium">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <input 
                      ...
                      className="w-16 p-1.5 border border-gray-200 dark:border-emerald-800/50 rounded-md text-center focus:ring-2 focus:ring-primary focus:border-transparent outline-none font-semibold text-primary"
                    />
                  </div>
                </div>
              </div>
