...
export default function SugarCurveChart({ currentGL, swapGL }: SugarCurveChartProps) {
  ...
  return (
    <div className="w-full h-64 mt-4 bg-white/60 p-4 rounded-xl border border-gray-100 dark:border-emerald-900/50 shadow-inner">
      <h4 className="text-sm font-semibold text-gray-700 dark:text-emerald-200 mb-4 font-heading text-center">
        {t('chart.title')}
      </h4>
